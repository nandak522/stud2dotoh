...
urlpatterns = patterns('quest.views',
    (r'^$', 'view_questions', {'questions_template':'questions.html'}, 'all_questions'),#TODO:Url name 'all_questions' will be changed to 'questions'
    ...
    (r'^(?P<tag_name>[\w.-]+)/$', 'view_tagged_questions', {'tagged_questions_template':'tagged_questions.html'}, 'tagged_questions'),
)
