...
function save_personal_settings(form_name){
	...
	ajaxPost('/settings/personal/', {'name':form.name.value, 'slug':slug, 'new_password':form.new_password.value, 'successCallback':settings, 'successCallbackParams':'personal'});
...
function save_workinfo_settings(form_name){
	...
	ajaxPost('/settings/workinfo/', {'workplace':form.workplace.value, 'designation':form.designation.value, 'years_of_exp':form.years_of_exp.value, 'successCallback':settings, 'successCallbackParams':'workinfo'});
}
